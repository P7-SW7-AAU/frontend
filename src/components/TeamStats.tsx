      ...
      <div className="text-center space-y-2">
        ...
        <div className="flex items-center justify-center space-x-4">
          ...
          <Badge 
            ...
            className={"px-3 py-1 bg-primary-yellow text-black font-bold"}
          >
            #{ranking} in League
          </Badge>
        </div>
        ...
        <CardContent>
          <div className="space-y-2">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-xl font-semibold text-primary-green">{projectedPoints}</span>
            </div>
            <div className="w-full bg-secondary rounded-full h-2 mt-3">
              <div
                className="bg-primary-green h-2 rounded-full transition-all duration-1000 ease-out"
